...
Additionally, the way I calculate embeddings for all the books on every recommendation request which is not optimal by any means. One way how this could be improved is to calculate the embedding upon the insertion of a book to a database and for the purpose of storing it we could leverage vector databases but once again this goes beyond the scope of this project and you can explore it on your own.
