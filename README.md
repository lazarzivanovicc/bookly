...
Cosine similarity is given by the formula: $\text{cosine\_similarity}(\mathbf{A}, \mathbf{B}) = \frac{\mathbf{A} \cdot \mathbf{B}}{\|\mathbf{A}\| \cdot \|\mathbf{B}\|}$
...
For the purpose of practicing my Clojure skills I implemented dot product, Euclidian norm and cosine similarity functions but for the purposes of building real life applications and more complex matrix and vector operations one should use specialized libraries like (Neanderthal)
[https://github.com/uncomplicate/neanderthal] or (clojure.core.matrix)[https://github.com/mikera/core.matrix].
